    ...
    <section>
      ...
      <div className="flex flex-col py-20  font-['Roboto'] dark:bg-gray-900 dark:border-[#e5e7eb]">
        <div className="flex flex-col p-[5px] space-y-4">
          <h1 className="text-center text-4xl font-bold leading-tight tracking-tight text-gray-700 dark:text-white">
            Send us a message
          </h1>
        ...
        <div className="space-y-4 w-full flex justify-center">
          <form
            action="#"
            className="flex flex-col p-6 space-y-4 xsm:w-screen sm:w-1/3"
          >
            ...
            <textarea
              ...
              placeholder="Message"
            ></textarea>
            <button className="bg-blue-700 text-xl p-2 text-orange-100 hover:bg-gray-700">
              Send
            </button>
          </form>
        </div>

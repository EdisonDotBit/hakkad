  ...
  return (
    <>
      <div className="p-10 flex flex-col justify-center items-center font-poppins">
        ...
        <div className="xsm:w-full sm:w-full pb-7 pt-[80px] flex flex-col items-center">
          <h1 className="xsm:text-[30px] sm:text-[50px] font-semibold text-center xsm:w-screen sm:w-[1100px] text-black">
            Website Security Training for IT Students at Rizal Technological
            University
          </h1>
          <p className="xsm:w-full sm:w-[700px] text-center pt-1">
        ...
        <div className="flex gap-2 pb-[150px]">
          <NavLink
            to="/LoginPage"
            className="py-4 px-8 bg-[#3f83e8] text-[14px] text-white w-[190px] text-center rounded-md hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-primary-300"
          >
            Get Started
          </NavLink>
        </div>
